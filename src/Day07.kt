                ...
                when {
                    ...
                    aStrength < bStrength -> -1
                        ...
                        for ((i, aChar) in a.cards.withIndex()) {
                            ...
                            val bCardStrength = cardStrengthsWithWildCards.indexOf(b.cards[i])
                            return@sortedWith when {
                                aCardStrength > bCardStrength -> 1
                                aCardStrength < bCardStrength -> -1
                                else -> continue
...
fun handStrengthWithWildcards(hand: String): Int {
    ...
    val charGroups = groups.values.dropWhile { chars -> chars.all { it == 'J' } }.sortedBy { it.size }
    return when {
        // five of a kind
        ...
        // full house
        charGroups.run { wildCards.size >= 3 || size == 2 } -> 5
        // three of a kind
